    ...
    <section className="w-full bg-transparent py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-8 text-center py-8 lg:py-12">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">Jimmy</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <a
              href="#projects"
              className="rounded-full bg-black px-8 py-3 text-base font-medium text-white hover:opacity-90 hover-lift"
            >
              查看项目
            </a>
            <a
              href="#contact"
              className="rounded-full border px-8 py-3 text-base font-medium hover:bg-black/5 hover-lift"
            >
              联系我
            </a>
          </div>
